...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './judet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JUDET_LIST actions', async () => {
    ...
    it('dispatches FETCH_JUDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JUDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JUDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JUDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JUDET actions', async () => {
      const expectedActions = [
        {
